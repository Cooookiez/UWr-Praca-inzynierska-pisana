...
\begin{figure}[H]%
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.8\linewidth]{imgs/etui_bot_v1.jpg}
		\caption{etui\_bot\_v1.STL \cite{img_me}.}	
		\label{etui_bot:1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.8\linewidth]{imgs/etui_bot_v7.1.jpg}
		\caption{etui\_bot\_v7.1.STL \cite{img_me}.}
		\label{etui_bot:7.1}
	\end{subfigure}%
\caption{Komunikaty graficzne}
\label{etui_bot:etui_bot}
\end{figure}
...
\begin{figure}[H]%
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.8\linewidth]{imgs/etui_bot_v9.1.jpg}
		\caption{etui\_bot\_v9.1.STL \cite{img_me}.}	
		\label{etui_bot:9.1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.8\linewidth]{imgs/etui_bot_v10.2.jpg}
		\caption{etui\_bot\_v10.2.STL \cite{img_me}.}
		\label{etui_bot:10.2}
	\end{subfigure}%
\caption{Kilka wersji etui}
\label{etui_bot:etui_bot}
\end{figure}
...
\caption{etui\_bot\_v1.STL \cite{img_me}. \label{etui_bot_1}}
\quad
\end{figure}
...
\caption{etui\_bot\_v7.1.STL \cite{img_me}. \label{etui_bot_7.1}}
\quad
\end{figure}
