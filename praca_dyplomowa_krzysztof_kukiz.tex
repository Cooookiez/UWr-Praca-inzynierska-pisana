...
\begin{figure}[!ht]%
\centering
\includegraphics[width=0.8\columnwidth]{imgs/etapy.drawio.png}
...
\begin{figure}[!ht]%
\centering
\includegraphics[width=0.8\columnwidth]{imgs/glowny.drawio.png}
\caption{Program główny \cite{img_by_me} \label{algorytm_start_recognition}}
\quad
\end{figure}
