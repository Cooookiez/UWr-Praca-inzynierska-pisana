...
def screenVisualization():
    match appActiveMode:
        case Mods.PROCESSING:
            Tk.configure(background=appBackground["PROCESSING"])
            pass
        case Mods.IDLE:
            Tk.configure(background=appBackground["IDLE"])
            pass
        case Mods.UNKNOWN:
            Tk.configure(background=appBackground["UNKNOWN"])
            pass
        case Mods.KNOWN:
            Tk.configure(background=appBackground["KNOWN"])
            pass
    Tk.update()
\end{minted}
\end{mdframed}
...
\end{minted}
\end{mdframed}
\caption{Obsługa sytuacji w której twarz nie została rozpoznana}
\label{listing:py1}
\end{listing}
