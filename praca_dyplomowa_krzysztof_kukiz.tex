...
\newline
System oparty jest na Raspberry Pi 4B, na języku programowania python 3. Oraz wykorzystuje elementy wydrukowane na drukarce 3D Creality Ender-3 v.2
\newline
...
\begin{enumerate} % itemize
  \item Warstwę sprzętową składającą się z czterech elementów.
  \begin{itemize}
  	...
  	\item \textcolor{red}{Wyświetlacza}
  \end{itemize}
  ...
  \begin{itemize}
  	...
  	\item Informacyjn zawierającą podstawowe informacje o produkcie
  \end{itemize}
\end{enumerate}
