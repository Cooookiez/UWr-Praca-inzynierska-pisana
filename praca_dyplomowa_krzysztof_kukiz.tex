...
\caption{Zdjęcie x. Kamera HD [źródło: https://botland.com.pl/kamery-do-raspberry-pi/6124-raspberry-pi-camera-hd-v2-8mpx-oryginalna-kamera-do-raspberry-pi-652508442112.html] \label{kamera}}
\quad
\end{figure}
...
\caption{Zdjęcie x. Raspberry Pi 4B [źródło: https://botland.com.pl/moduly-i-zestawy-raspberry-pi-4b/16579-raspberry-pi-4-model-b-wifi-dualband-bluetooth-8gb-ram-15ghz-765756931199.html] \label{rp4b}}
\quad
\end{figure}
...
\caption{Zdjęcie x. Głośniki LOGIC CONCEPT LS-09 [źródło: własne] \label{glosnik}}
\quad
\end{figure}
...
\caption{Zdjęcie x. Ekran Waveshare 9904 [źródło: https://botland.com.pl/wyswietlacze-raspberry-pi/4479-ekran-dotykowy-a-rezystancyjny-lcd-tft-35-320x480px-gpio-dla-raspberry-pi-4-3-2-b-zero-waveshare-9904-5904422371296.html] \label{ekran}}
\quad
\end{figure}
...
\caption{PDCA – Iteracja \textcolor{edited}{Początkowa} [materiały własne] \label{PDCA_00}}
\quad
\end{figure}
...
\caption{PDCA – Iteracja \textcolor{edited}{pośrednia 1} [materiały własne] \label{PDCA_01}}
\quad
\end{figure}
...
\caption{PDCA – Iteracja \textcolor{edited}{pośrednia 2} [materiały własne] \label{PDCA_02}}
\quad
\end{figure}
...
\caption{PDCA – Iteracja \textcolor{edited}{pośrednia 32} [materiały własne] \label{PDCA_03}}
\quad
\end{figure}
...
\caption{PDCA – Iteracja \textcolor{edited}{końcowa} [materiały własne] \label{PDCA_END}}
\quad
\end{figure}
...
\caption{\textcolor{new}{Wszystkie wydrukowane Iteracje PDCA} [materiały własne] \label{PDCA_ALL}}
\quad
\end{figure}
